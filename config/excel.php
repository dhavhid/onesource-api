...
return array(
    ...
    'properties' => array(
        'creator'        => 'OneSource Scheduling',
        'lastModifiedBy' => 'OneSource Scheduling',
        'title'          => '',
        'description'    => 'Default spreadsheet export',
        'subject'        => 'Spreadsheet export',
        'keywords'       => 'onesource, excel, export',
        'category'       => 'Excel',
        'manager'        => 'OneSource Scheduling',
        'company'        => 'OneSource Scheduling',
    ),
